 ...
 * @author lalo
 */
public class crud_modificar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet crud_modificar</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet crud_modificar at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
      ...
      public void modificar(HttpServletRequest request)
    {
        ...
        String juego_descripcion = request.getParameter("j_descripcion");
              ...
              Juegos capturar = new Juegos(juego_codint, juego_nombre, juego_descripcion, juego_valor, juego_req_min, juego_req_max, juego_URL_IMG, juego_trailer);
           
               juegosFacade.edit(capturar);
